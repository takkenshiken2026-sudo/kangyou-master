...
管業は5出題分野のため「5行表」、マン管は「7行表」——いずれも「分野別正答率表」へ統一。
...
JARGON_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    (r"5行表1行", "分野別正答率1行"),
    (r"7行表1行", "分野別正答率1行"),
    (r"5行表70％", "分野別正答率表での70％配分"),
    (r"7行表70％", "分野別正答率表での70％配分"),
    (r"5行表48％", "分野別正答率表での48％ライン"),
...
JARGON_CHECK_RE = re.compile(
    r"5行表|7行表|/terms/|terms/|Day3解き直し|Day0→3→7"
)
