...
7. [.cursor/rules/affiliate-article.mdc](../.cursor/rules/affiliate-article.mdc) … アフィリエイト記事・ブリーフ編集時
8. [.cursor/rules/exam-site-shell-template.mdc](../.cursor/rules/exam-site-shell-template.mdc) … テンプレ全体の必須事項（常時適用）
